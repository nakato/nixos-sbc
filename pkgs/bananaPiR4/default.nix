  ...
  linuxPackages_frankw_6_12_bananaPiR4 = linuxKernel.packagesFor (linux_6_12.override {
    ...
    argsOverride = {
      src = fetchFromGitHub {
        ...
        # 6.12-main HEAD 2025-06-09
        rev = "cc5725a0f60d64047351086e83d9733f063a153b";
        hash = "sha256-ii06fJVQN2ZEMtYXJnLWB4MWgYxRiLfuCGO+UePAvdU=";
      };
      version = "6.12.32-bpi-r4";
      modDirVersion = "6.12.32-bpi-r4";
    };
