...
in {
  inherit (bananaPiR3) armTrustedFirmwareMT7986 linuxPackages_latest_bananaPiR3 linuxPackages_6_10_bananaPiR3 ubootBananaPiR3 linuxPackages_6_10_bananaPiR3_minimal;
  inherit (bananaPiR4) armTrustedFirmwareMT7988 linuxPackages_frankw_latest_bananaPiR4 linuxPackages_frankw_6_10_bananaPiR4 ubootBananaPiR4;
